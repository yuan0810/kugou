window.onload = function() {
    //选项卡
    var ba = document.querySelectorAll('.btn a');
    var bli = document.querySelectorAll('.btn li');
    var cli = document.querySelectorAll('.cont li');
    var index = 0;
    for (var i = 0; i < ba.length; i++) {
        ba[i].onclick = function() {
            for (var j = 0; j < ba.length; j++) {
                cli[j].style.display = 'none';
                bli[j].className = 'active2';
                ba[j].className = '';
            }
            var index = this.getAttribute('data-index');
            cli[index].style.display = "block";
            bli[index].className = '';
            ba[index].className = 'active';
        }
    }
    //选项卡完成
    var input = document.querySelector('.file input');
    var imgdiv = document.querySelector('.imgdiv2');
    var yimg = document.querySelector('.imgdiv2 img');
